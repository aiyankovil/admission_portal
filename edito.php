...
$mathmark = mysql_real_escape_string($_POST['mathmark']);
    ...
    $query="UPDATE basic_info b,education_qualification r
            SET firstName='$name',lastName='$name1',physicsmark='$phymark',chemistrymark='$chemark',mathsmark='$mathmark'
                                                        ...
                                                        <table width="100%" border="0" cellpadding="4" cellspacing="0" id="Table2" bgcolor="#e0e0e0">
                                                            <tbody><tr bgcolor="white">
                                                                <td class="tdtext" width="30%">
                                                                    Full Name</td>
                                                                <td class="tdtext">
                                                                    <input name="name" name="name1" value="<?php echo $row ['firstName'] ,' ', $row['middleName'] ,' ' ,$row['lastName'] ?>"type="text" maxlength="20"  class="text" size="40" onblur="check(this)">&nbsp;<span id="val_name" style="color:#F00;" title="enter the name"></span>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tbody><tr>
                                                    <td>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="Table9">
                                                            <tbody><tr>
                                                                <td bgcolor="#339966" width="34%"><img height="10" src="./list_files/spacer.gif" width="2"><span class="wtext"> Marks Obtained in 12th Standard
                                                                    </span>
                                                                </td>
                                                                <td width="33%">
                                                                    </td>
                                            ...
                                            <table width="95%" align="center" cellpadding="4" cellspacing="0">
                                                <tbody><tr bgcolor="#ffffff">
                                                    ...
                                                    <td class="bld" align="center" width="33%">
                                                       <input type="submit" name="edit" value="Edit"  class="submit" style="color:Black;bgcolor="> 
                                                    </td>
                                                    <?php
                                                    if(isset($_POST['edit']))
                                                    {
                                                     ?>
                                                     <td class="bld" align="left" width="33%">
                                                       <input type="submit" name="save" value="Save"  class="submit" style="color:Black;bgcolor="> <?php

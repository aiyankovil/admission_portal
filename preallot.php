            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#vali">VALIDATE</a></li>
                        <li><a href="#rank">Rank List</a></li>
                        <li><a href="#seat">SEAT SETTINGS</a></li>
			...
			<div class="container">
				<div class="row mb50">
					...
					<div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
						<p> EDIT DETAILS OF THE APPLICANT</p>
					</div>
					
                    <div class="col-md-offset-4 col-md-4 text-center">
					<br/><br/><a href="list1.php"><button type="button" class="btn btn-lg btn-proceed hvr-fade">PROCEED</button>
		...
		<section id="rank" class="allot">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-offset-2 col-md-10 list">
						<p><br><br><br>CLICK TO PREPARE RANK LIST OF STUDENTS BASED ON +2 AND ENTRANCE MARKS<br></p>
					</div>
     <div class="col-md-offset-4 col-md-4 text-center">
					<br/><br/><a href="preparerank.php"><button type="button" class="btn btn-lg btn-proceed hvr-fade">PREPARE</button>

					</div>
						<div class="col-md-offset-2 col-md-10 list">
						<p><br><br><br> &nbsp;&nbsp;  &nbsp; &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp; BY CLICKING ON PROCCED VIEW RANK LIST <br></p>
					</div>
                     <div class="col-md-offset-4 col-md-4 text-center">
					<br/><br/><a href="rank.php"><button type="button" class="btn btn-lg btn-proceed hvr-fade">PROCEED</button>
		...
		<section id="seat" class="date">
			<div class="container">
				<div class="row mb50">
					...
					<div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
						<p> SET OUT AVAILABLE SEAT FOR EACH DEPARTMENT</p>
					</div>
                    <div class="col-md-offset-4 col-md-4 text-center">
					<br/><br/><a href="seat.php"><button type="button" class="btn btn-lg btn-proceed hvr-fade">PROCEED</button>

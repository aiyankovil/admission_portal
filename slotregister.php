			...
			<div class="container">
				<div class="row mb50">
					...
					<div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
						<p> TO SEE DETAILS OF THE CANDIATE TO ALLOT SLOT</p>
					</div>
...
<?php }?>
			...
			<div class="container">
				<div class="row mb50">
					...
					<div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
						<p> ALLOT TO REPORTED SLOT BASED ON SLOT ALLOTMENT</p>
					</div>
					<div class="col-md-offset-3 col-md-10 list">
					<br>
...
$con=mysql_connect("localhost","root","")or die("canot connect");
		...
		if(isset($_POST['btn1']))
			{ 
  					...
  					if($d_br=='slot1'){
  				echo "<script>alert('slot1');</script>";	
 				$insQuery= "insert into slot1(fname,App_no) values('{$d_name}',{$d_no})";}
  				elseif ($d_br=='slot2') {
  					echo "<script>alert('slot2');</script>";
  						$insQuery= "insert into slot2(fname,App_no) values('{$d_name}',{$d_no})";
  				}
  				elseif ($d_br=='slot3'){ 
  					echo "<script>alert('slot3');</script>";
  					$insQuery= "insert into slot3(fname,App_no) values('{$d_name}',{$d_no})";}

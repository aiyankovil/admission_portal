...
mysql_select_db("admin",$con)or die("error in database");
$d = $_REQUEST['delete'];
$e = $_REQUEST['edit'];
$app = $_REQUEST['txt_appno'];
if(isset($d)){
    $query = mysql_query("DELETE FROM student_details WHERE appno = '$app'")
or die("Diee");
            ...
            <div class="container">
                <div class="row mb50">
                    ...
                    <div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
                        <p> TO CANCEL THE ALLOTMENT OF A CANDIDATE ON REQUEST</p>
                    </div>
...
<tbody>
    <tr>
        ...
        <td><a href="list.php?appno=<?php echo $row['application_no']."&";?>delete=1">CANCEL ALLOTMENT</a></td>
    </tr>
</tbody>    
</table>
<?php }?>
